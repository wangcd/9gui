...
<div class="blank"></div>
 <div id="ur_here">
当前位置: <a href=".">首页</a> <code>&gt;</code> <a href="category-2-b0.html">价格</a> <code>&gt;</code> 中国张裕馆藏干红葡萄酒 750ml 
</div>
</div>
<div class="blank"></div>   
   <div id="goodsInfo" class="clearfix">
     ...
     <div class="imgInfo">
     <a href="images/201403/goods_img/6_P_1395444655879.jpg" id="zoom1" class="MagicZoom MagicThumb" title="中国张裕馆藏干红葡萄酒 750ml">
      <img src="images/201403/goods_img/6_G_1395444655173.jpg" alt="中国张裕馆藏干红葡萄酒 750ml" width="360px;" height="360px"/>
     </a>
     <div class="blank5"></div>
    <div style="text-align:center; position:relative; width:100%;">
               <a href="javascript:;" onclick="window.open('gallery.php?id=6'); return false;"><img alt="zoom" src="themes/red_two/images/zoom.gif" /></a>
            <a href="goods-5.html"><img style="position: absolute;right:0;"  alt="next" src="themes/red_two/images/down.gif" /></a>
            </div>
      ...
      <div class="picture" id="imglist">
           ...
           <a  href="images/201403/goods_img/6_P_1395444655879.jpg"
    	rel="zoom1" 
        rev="images/201403/goods_img/6_P_1395444655879.jpg"
        title="">
        <img src="images/201403/thumb_img/6_thumb_P_1395444655427.jpg" alt="中国张裕馆藏干红葡萄酒 750ml" class="onbg" /></a>
...
<script type="text/javascript">
	mypicBg();
     ...
     <form action="javascript:addToCart(6)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
	  ...
	  <ul class="ul2 clearfix">
       ...
       <strong>本店售价：</strong><font class="shop" id="ECS_SHOPPRICE">¥88.00</font> 
   
	   
	          <font class="market">¥118.00</font> 
              </dd>
       </li>
  ...
  <li class="clearfix">
       <dd >
              ...
              注册用户：<font class="f1" id="ECS_RANKPRICE_1" style=" padding-right:10px;">¥88.00</font> 
              
        <a href="javascript:collect(6)">收藏</a> |  
           </dd>
      </li>
      ...
      <li class="padd">
      <a href="javascript:addToCart(6)"><img src="themes/red_two/images/goumai2.gif" /></a>
   ...
   <div class="blank"></div>
     ...
     <div class="box">
      ...
      <table class="table" width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#dddddd">
          ...
          <td bgcolor="#FFFFFF" align="left" width="70%">中国</td>
        </tr>
                <tr>
